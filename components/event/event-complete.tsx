...
export default function EventComplete({ totalRounds }: { totalRounds: number }) {
  return (
    <BentoCard glowColor="signal" className="p-10 md:p-12 text-center relative overflow-hidden group border-[#00E5FF]/20 bg-[#00E5FF]/5">
      <div className="absolute inset-0 bg-[#00E5FF]/5 rounded-full blur-3xl pointer-events-none transition-all duration-500 group-hover:bg-[#00E5FF]/10" />

      <div className="flex justify-center mb-8 relative z-10">
        <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-[#00E5FF]/10 border border-[#00E5FF]/40 shadow-[0_0_30px_rgba(125,249,255,0.3)]">
          <CheckCircle2 className="h-10 w-10 text-[#00E5FF]" />
        </div>
      </div>

      <p className="font-mono text-[10px] uppercase text-[#00E5FF] tracking-[0.2em] mb-2 font-semibold relative z-10">TACTICAL STAGE COMPLETE</p>
